        ...
        <div class="modal-content border-0 shadow-lg rounded-4">
            ...
            <div class="modal-body p-4 text-center">
                <div class="mb-3">
                    ...
                    <h5 class="fw-bold text-dark mb-2">Rekap Absensi Tidak Tersedia</h5>
                    <p class="text-muted mb-1">Hari ini adalah <strong class="text-danger">{{ $dailyStatus['status'] }}</strong>.</p>
                    <p class="text-muted small mb-0">Rekap & Konfirmasi Absensi hanya aktif pada hari belajar. Seluruh siswa berstatus <strong>LIBUR</strong> hari ini.</p>
                </div>
                        ...
                        @forelse($students as $student)
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    @if ($dailyStatus['is_holiday'])
                                        {{-- Hari Libur: Seluruh siswa tampil LIBUR (presentational, tidak ubah DB) --}}
                                        <span class="badge bg-secondary px-3 py-2">
                                            <i class="bi bi-moon-stars-fill me-1"></i> LIBUR
                                        </span>
                                    @else
