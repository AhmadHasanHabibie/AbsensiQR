...
<div class="container-fluid">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4">
        <div>
            <h3 class="fw-bold mb-1">Tambah Operator</h3>
            <p class="text-muted mb-0">Tambahkan data operator baru ke dalam sistem.</p>
        </div>
        ...
        <div class="col-lg-8">
            <div class="card border-0 rounded-4 shadow-sm">
                <div class="card-header bg-white py-3 px-4 border-bottom">
                    <h5 class="mb-0 fw-bold text-dark"><i class="bi bi-person-plus text-primary me-2"></i>Formulir Tambah Data Operator</h5>
                </div>
                    ...
                    <form action="{{ route('admin.operator.store') }}" method="POST">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="name"
                                       ...
                                       value="{{ old('name') }}" placeholder="Masukkan nama operator">
                                @error('name')
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="nip"
                                       ...
                                       value="{{ old('nip') }}" placeholder="Masukkan NIP operator">
                                @error('nip')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-save me-2"></i> Simpan Operator
                            </button>
                        </div>
