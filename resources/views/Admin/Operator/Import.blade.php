...
@section('title', 'Import Data Operator')
...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h3 class="fw-bold text-primary mb-1">Import Data Operator</h3>
            <p class="text-muted mb-0">Upload file Excel (.xlsx / .xls) untuk menambahkan data operator secara massal.</p>
        </div>
        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body p-4">
                    <form action="{{ route('admin.operator.import') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-4">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('admin.operator.template') }}" class="btn btn-outline-primary">
            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    <ol class="mb-0">
                        ...
                        <li class="mb-2">Isi data operator sesuai format kolom.</li>
            ...
            <div class="card border-0 shadow-sm mt-3">
                ...
                <div class="card-body">
                    <table class="table table-sm mb-0">
                        ...
                        <tbody>
                            <tr><td>A</td><td>Nama Operator</td><td><span class="badge bg-danger">Ya</span></td></tr>
