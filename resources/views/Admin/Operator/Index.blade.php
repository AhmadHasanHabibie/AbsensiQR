...
<div class="container-fluid">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4">
        <div>
            <h3 class="fw-bold mb-1">Data Operator</h3>
            <p class="text-muted mb-0">Kelola akun operator absensi.</p>
        </div>
        <div class="d-flex gap-2">
            <a href="{{ route('admin.operator.import.form') }}" class="btn btn-success">
                <i class="bi bi-file-earmark-excel me-2"></i> Import Excel
            </a>
            <a href="{{ route('admin.operator.template') }}" class="btn btn-outline-success">
    ...
    <div class="card border-0 rounded-4 shadow-sm">
        <div class="card-header bg-white py-3 px-4 border-bottom">
            <h5 class="mb-0 fw-bold text-dark"><i class="bi bi-qr-code-scan text-primary me-2"></i>Daftar Petugas Operator QR</h5>
        </div>
        <div class="card-body p-4">

            {{-- Search Bar --}}
            <form action="{{ route('admin.operator.index') }}" method="GET" class="mb-4">
                <div class="row g-2">
                    <div class="col-md-6 col-lg-5">
                        <div class="input-group">
                            ...
                            <input type="text" name="search" class="form-control border-start-0 ps-0"
                                   value="{{ request('search') }}" placeholder="Cari Nama, NIP, atau Username Operator...">
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 col-lg-2">
                        <a href="{{ route('admin.operator.index') }}" class="btn btn-outline-secondary w-100 fw-semibold">
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle">
                    ...
                    @forelse($operators as $operator)
                        <tr>
                            <td class="fw-semibold text-muted">{{ $loop->iteration + ($operators->currentPage() - 1) * $operators->perPage() }}</td>
                            <td>
                            ...
                            <td><span class="badge bg-light text-dark">{{ $operator->nip }}</span></td>
                            ...
                            <td>
                                <div class="d-flex gap-1">
                                    <a href="{{ route('admin.operator.show', $operator->id) }}"
