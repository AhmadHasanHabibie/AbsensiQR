...
{{-- ============================================================ --}}
{{-- HOLIDAY LOCK MODAL (TAHAP 4) — Hanya untuk Hari Ini Libur --}}
{{-- ============================================================ --}}
@if ($isToday && $dailyStatus['is_holiday'])
        ...
        <div class="modal-content border-0 shadow-lg rounded-4">
            ...
            <div class="modal-body p-4 text-center">
                <div class="mb-3">
                    ...
                    <h5 class="fw-bold text-dark mb-2">Monitoring Tidak Tersedia</h5>
                    <p class="text-muted mb-1">Hari ini adalah <strong class="text-danger">{{ $dailyStatus['status'] }}</strong>.</p>
                    <p class="text-muted small mb-0">Monitoring Absensi Harian hanya aktif pada hari belajar. Data historis tetap dapat dilihat dengan memilih tanggal lain.</p>
                </div>
            ...
            <div class="modal-footer bg-light rounded-bottom-4 p-3 d-flex justify-content-center">
                <a href="{{ route('piket.dashboard') }}" class="btn btn-danger px-5 fw-semibold rounded-pill">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.getElementById('holidayModalCloseBtn').addEventListener('click', function () {
            window.location.href = '{{ route("piket.dashboard") }}';
        });
    });
</script>
@endif
