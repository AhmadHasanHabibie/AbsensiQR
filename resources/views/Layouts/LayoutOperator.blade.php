...
<head>
    ...
    <title>@yield('title') - Operator SMKN 17</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .sidebar {
            background: linear-gradient(180deg, #0a1628 0%, #0d6efd 100%);
            color: #fff;
            display: flex;
        ...
        .navbar-custom .user-avatar {
            width: 36px; height: 36px; background: linear-gradient(135deg, var(--primary), #0dcaf0);
...
<div class="sidebar offcanvas-lg offcanvas-start" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
    ...
    <div class="sidebar-menu">
        ...
        <a href="{{ route('operator.scan.index') }}"
           class="{{ request()->routeIs('operator.scan.*') ? 'active' : '' }}">
            <i class="bi bi-qr-code-scan"></i>
            Scan QR
        </a>

        <a href="{{ route('operator.terlambat.index') }}"
           class="{{ request()->routeIs('operator.terlambat.*') ? 'active' : '' }}">
            <i class="bi bi-alarm-fill"></i>
            Data Terlambat
        </a>

        <a href="{{ route('operator.emergency.index') }}"
           class="{{ request()->routeIs('operator.emergency.*') ? 'active' : '' }}">
            <i class="bi bi-exclamation-triangle-fill"></i>
            Absensi Darurat
        </a>

        <a href="{{ route('operator.profil.index') }}"
           class="{{ request()->routeIs('operator.profil.*') ? 'active' : '' }}">
    ...
    <nav class="navbar navbar-custom d-flex align-items-center">
        ...
        <div class="ms-auto user-info">
            <div class="text-end d-none d-sm-block">
                ...
                <div class="user-role">Operator Operasional</div>
            </div>
