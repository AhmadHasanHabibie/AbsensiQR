...
<head>
    ...
    <title>500 - Masalah Server Internal | Sistem Absensi QR Code</title>
...
<body>
    ...
    <div class="error-card p-4 p-sm-5 text-center">
        ...
        <div class="error-badge mb-3">
            <i class="bi bi-exclamation-triangle-fill"></i> HTTP Status 500
        </div>

        <h2 class="fw-bold text-white mb-2 fs-3">Terjadi Kendala pada Server</h2>
        
        <p class="text-white-50 mb-4 fs-6">
            Terjadi kendala teknis sementara pada server kami. Silakan muat ulang halaman atau coba kembali beberapa saat lagi.
        </p>
