...
<head>
    ...
    <title>429 - Permintaan Terlalu Banyak | Sistem Absensi QR Code</title>
...
<body>
    ...
    <div class="error-card p-4 p-sm-5 text-center">
        ...
        <div class="error-badge mb-3">
            <i class="bi bi-lightning-charge-fill"></i> HTTP Status 429
        </div>

        <h2 class="fw-bold text-white mb-2 fs-3">Permintaan Terlalu Banyak</h2>
        
        <p class="text-white-50 mb-4 fs-6">
            Perangkat Anda mengirimkan terlalu banyak permintaan dalam waktu singkat demi keamanan server. Silakan tunggu beberapa detik lalu muat ulang halaman.
        </p>
