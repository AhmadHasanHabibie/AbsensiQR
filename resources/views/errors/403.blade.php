...
<head>
    ...
    <title>403 - Akses Ditolak | Sistem Absensi QR Code</title>
...
<body>
    ...
    <div class="error-card p-4 p-sm-5 text-center">
        ...
        <div class="error-badge mb-3">
            <i class="bi bi-exclamation-octagon-fill"></i> HTTP Status 403
        </div>

        <h2 class="fw-bold text-white mb-2 fs-3">Akses Ditolak / Forbidden</h2>
        
        <p class="text-white-50 mb-4 fs-6">
            Maaf, akun Anda tidak memiliki hak akses untuk membuka halaman ini. Silakan periksa kembali tautan Anda atau kembali ke dashboard resmi Anda.
        </p>
        ...
        <div class="d-flex flex-column flex-sm-row align-items-center justify-content-center gap-2 mt-2">
            <button onclick="reloadCurrentPage()" class="btn btn-warning text-dark px-4 py-2.5 rounded-pill fw-bold btn-action w-100 w-sm-auto">
                <i class="bi bi-arrow-clockwise me-1" id="refreshIcon"></i> Muat Ulang Halaman
            </button>
