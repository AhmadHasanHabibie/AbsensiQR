...
<head>
    ...
    <title>404 - Halaman Tidak Ditemukan | Sistem Absensi QR Code</title>
...
<body>
    ...
    <div class="error-card p-4 p-sm-5 text-center">
        ...
        <div class="error-badge mb-3">
            <i class="bi bi-question-circle-fill"></i> HTTP Status 404
        </div>

        <h2 class="fw-bold text-white mb-2 fs-3">Halaman Tidak Ditemukan</h2>
        
        <p class="text-white-50 mb-4 fs-6">
            Alamat web yang Anda tuju tidak ditemukan, telah dipindahkan, atau tidak lagi tersedia. Silakan muat ulang atau kembali ke dashboard utama.
        </p>
